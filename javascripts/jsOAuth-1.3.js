...
exports.OAuth = (function (global) {
    ...
    OAuth.prototype = {
        ...
        init: function (options) {
            ...
            this.request = function (options) {
                var method, url, data, headers, success, failure, xhr, i,
                    ...
                    query = [], appendQueryString, signatureData = {}, params, withFile, urlString, aync;
         ...
         */
        get: function (url, success, failure, aync) {
            this.request({'url': url, 'success': success, 'failure': failure, 'aync': aync});
        },
         ...
         * @param failure {function} callback for a failed request
         */
        getJSON: function (url, success, failure, aync) {
